...
import { It as formatUsageWindowSummary, Lt as resolveUsageProviderId, Pt as loadProviderUsageSummary, Ur as resolveModelWithRegistry, a as buildAuthHealthSummary, i as DEFAULT_OAUTH_WARN_MS, ln as describeFailoverError, o as formatRemainingShort, r as maskApiKey, w as runEmbeddedPiAgent } from "./reply-CCBexja_.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-C_RF521q.js";
...
import { $t as loadConfig, Ct as resolveProfileUnusableUntilForDisplay, Dn as parseDurationMs, Gi as DEFAULT_PROVIDER, Nt as resolveSecretRefString, Oi as resolveAuthStorePathForDisplay, Pi as resolveAuthProfileDisplayLabel, Si as ensureAuthProfileStore, Wi as DEFAULT_MODEL, _t as resolveAuthProfileOrder, at as resolveEnvApiKey, c as modelKey, ci as getShellEnvAppliedKeys, d as normalizeProviderId, di as shouldEnableShellEnvFallback, f as parseModelRef, g as resolveDefaultModelForAgent, gi as listProfilesForProvider, gt as resolveAuthProfileEligibility, h as resolveConfiguredModelRef, i as findNormalizedProviderValue, it as resolveAwsSdkEnvVarName, ki as resolveOpenClawAgentDir, r as buildModelAliasIndex, rt as resolveApiKeyForProvider, tt as getCustomProviderApiKey, v as resolveModelRefFromString, vi as setAuthProfileOrder, yi as upsertAuthProfile } from "./model-selection-BaeHlT6A.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-CmT3i4wb.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-BoNnI0IY.js";
...
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-zC2LVJRu.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-DcsK8ZYD.js";
import "./session-cost-usage-D4slaGCr.js";
import { f as openUrl } from "./onboard-helpers-CKPkIyNp.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-tNdOjVQI.js";
import "./help-format-Dbqi5yWh.js";
import { r as withProgressTotals } from "./progress-D-QR55qI.js";
...
import { t as createClackPrompter } from "./clack-prompter-D48eqe_7.js";
import "./issue-format-DH2qIw2f.js";
import { t as renderTable } from "./table-DkyKnoNo.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-CJWbytFE.js";
import { n as redactSecrets } from "./format-CX_02LU0.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-Bx5MQoRM.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-Cgx0d-jz.js";
import { n as logConfigUpdated } from "./logging-CEi-PIBm.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, l as githubCopilotLoginCommand, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-nqAxrRjM.js";
...
async function runBuiltInOpenAICodexLogin(params) {
	...
	if (!creds) throw new Error("OpenAI Codex OAuth did not return credentials.");
	...
	await updateConfig((cfg) => {
		...
		if (params.opts.setDefault) next = applyOpenAICodexModelDefault(next).next;
		return next;
	});
	logConfigUpdated(params.runtime);
	params.runtime.log(`Auth profile: ${profileId} (openai-codex/oauth)`);
	if (params.opts.setDefault) params.runtime.log(`Default model set to ${OPENAI_CODEX_DEFAULT_MODEL}`);
	else params.runtime.log(`Default model available: ${OPENAI_CODEX_DEFAULT_MODEL} (use --set-default to apply)`);
}
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-BaeHlT6A.js").then((n) => n.ht);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		for (const entry of entries) {
			...
			rows.push(toModelRow({
				...
				cfg,
				authStore,
				allowProviderAvailabilityFallback: model ? !discoveredKeys.has(modelKey(model.provider, model.id)) : false
			}));
		}
	}
	if (rows.length === 0) {
