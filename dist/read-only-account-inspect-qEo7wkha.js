...
import { D as resolveThreadParentSessionKey, c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-CIXZm7v4.js";
import { ri as DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH } from "./model-selection-BaeHlT6A.js";
import { l as normalizeStringEntries, o as resolveChannelGroupToolsPolicy, t as getChannelDock } from "./dock-BI9_dwQi.js";
import { l as normalizeMessageChannel } from "./message-channel-CSTlX5lG.js";
import { S as inspectSlackAccount, a as inspectTelegramAccount, j as inspectDiscordAccount } from "./plugins-DD42H5-v.js";
import { S as normalizeToolName, T as matchesAnyGlobPattern, w as compileGlobPatterns, x as expandToolGroups } from "./sandbox-OEaNk7q1.js";
import { i as readChannelAllowFromStore } from "./pairing-store-B_ho1sqi.js";
import { i as resolveGroupAllowFromSources, r as mergeDmAllowFromSources } from "./allow-from-C29w5TTF.js";
...
function inspectReadOnlyChannelAccount(params) {
	if (params.channelId === "discord") return inspectDiscordAccount({
		cfg: params.cfg,
		accountId: params.accountId
	});
	if (params.channelId === "slack") return inspectSlackAccount({
		cfg: params.cfg,
		accountId: params.accountId
	});
	if (params.channelId === "telegram") return inspectTelegramAccount({
		cfg: params.cfg,
		accountId: params.accountId
	});
	return null;
...
//#endregion
export { resolveCommandAuthorizedFromAuthorizers as _, filterToolsByPolicy as a, resolveGroupToolPolicy as c, DM_GROUP_ACCESS_REASON as d, readStoreAllowFromForDmPolicy as f, resolvePinnedMainDmOwnerFromAllowlist as g, resolveDmGroupAccessWithLists as h, projectSafeChannelAccountSnapshotFields as i, resolveSubagentToolPolicy as l, resolveDmGroupAccessWithCommandGate as m, hasConfiguredUnavailableCredentialStatus as n, isToolAllowedByPolicies as o, resolveDmAllowState as p, hasResolvedCredentialValue as r, resolveEffectiveToolPolicy as s, inspectReadOnlyChannelAccount as t, pickSandboxToolPolicy as u, resolveControlCommandGate as v };