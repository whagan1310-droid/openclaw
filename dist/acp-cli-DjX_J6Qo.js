...
import { r as isKnownCoreToolId } from "./tool-catalog-U5Hs0dNI.js";
...
import { s as resolveGatewayCredentialsWithSecretInputs, t as buildGatewayConnectionDetails } from "./call-C79Luiuk.js";
...
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-D0u9YNYf.js";
...
function resolveAcpClientSpawnEnv(baseEnv = process.env, options) {
	const env = { ...baseEnv };
	if (options?.stripKeys) for (const key of options.stripKeys) delete env[key];
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-iyM9hX4-.js");
	const spawnEnv = resolveAcpClientSpawnEnv(process.env, { stripKeys: getActiveSkillEnvKeys() });
