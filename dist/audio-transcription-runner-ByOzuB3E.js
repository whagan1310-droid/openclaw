import { g as resolveAgentModelPrimaryValue, h as resolveAgentModelFallbackValues } from "./run-with-concurrency-C_CE05l4.js";
import { p as shouldLogVerbose, t as createSubsystemLogger, u as logVerbose, w as resolvePreferredOpenClawTmpDir } from "./subsystem-W834z9Wa.js";
import { _ as runExec } from "./workspace-pHGffow-.js";
import { M as resolveApiKeyForProvider, Z as loadConfig, c as normalizeProviderId, ct as mergeInboundPathRoots, g as normalizeGoogleModelId, j as requireApiKey, lt as resolveIMessageAttachmentRoots, ot as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, sr as resolveOpenClawAgentDir, st as isInboundPathAllowed } from "./model-selection-BI58zgyw.js";
import { x as normalizeChatType } from "./plugins--L1Azplm.js";
import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./image-ops-D3XDvn0o.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-DEVruB_i.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-DK5bYmSn.js";
import { n as fetchWithTimeout } from "./fetch-timeout-Wgx3OXYj.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DOq_LtZw.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-3XeDUVw_.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-ChfJDZwG.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-_Vup86TF.js").then((n) => n.r);
