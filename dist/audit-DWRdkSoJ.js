...
import { A as formatPermissionRemediation, M as safeStat, Qt as normalizeTrustedSafeBinDirs, R as createConfigIO, Rn as INCLUDE_KEY, dt as isDangerousNetworkMode, ft as normalizeNetworkMode, j as inspectPathPermissions, k as formatPermissionDetail, zn as MAX_INCLUDE_DEPTH } from "./auth-profiles-XSsJj4N1.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, d as resolveDefaultAgentId } from "./agent-scope-Bfb1NlQ6.js";
...
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-DODCpy2g.js";
import { d as normalizePluginsConfig } from "./manifest-registry-Dkqj8xGu.js";
import { n as MANIFEST_KEY } from "./legacy-names-CCXIUUJl.js";
import { l as normalizeStringEntries } from "./dock-sYVOKHlm.js";
import { n as listChannelPlugins } from "./plugins-DRFogx00.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-dCWvM5iw.js";
import { a as resolveGatewayAuth } from "./auth-vwV9EhNu.js";
import { n as resolveGatewayCredentialsFromConfig, t as isGatewaySecretRefUnavailableError } from "./credentials-CXPXvn09.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, i as resolveBrowserConfig } from "./server-context-Os1yOTFa.js";
import { i as loadWorkspaceSkillEntries } from "./skills-BCL68CAD.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-CJu-SGlX.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-i-ub-epr.js";
import { t as buildGatewayConnectionDetails } from "./call-C79Luiuk.js";
import { i as readChannelAllowFromStore } from "./pairing-store-Ds7wFtok.js";
import { _ as hasResolvedCredentialValue, g as hasConfiguredUnavailableCredentialStatus, h as inspectReadOnlyChannelAccount, l as resolveDmAllowState, n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-BJ05mNzH.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DoCeeQ32.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-J-SeKkxz.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-Dtko5sSp.js";
import { t as probeGateway } from "./probe-r7VymbY3.js";
import { r as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-B4fSinuT.js";
import { c as normalizeTelegramAllowFromEntry, s as isNumericTelegramUserId, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-DbdlW-cX.js";
...
async function collectChannelSecurityFindings(params) {
	...
	const inspectChannelAccount = (plugin, cfg, accountId) => plugin.config.inspectAccount?.(cfg, accountId) ?? inspectReadOnlyChannelAccount({
		channelId: plugin.id,
		cfg,
		accountId
	});
	...
	const resolveChannelAuditAccount = async (plugin, accountId) => {
		...
		const resolvedAccount = resolvedInspectedAccount ?? plugin.config.resolveAccount(params.cfg, accountId);
		...
		return {
			account,
			enabled: typeof selectedInspection?.enabled === "boolean" ? selectedInspection.enabled : typeof accountRecord?.enabled === "boolean" ? accountRecord.enabled : plugin.config.isEnabled ? plugin.config.isEnabled(account, params.cfg) : true,
			configured: typeof selectedInspection?.configured === "boolean" ? selectedInspection.configured : typeof accountRecord?.configured === "boolean" ? accountRecord.configured : plugin.config.isConfigured ? await plugin.config.isConfigured(account, params.cfg) : true
		};
	};
...
//#endregion
export { resolveGatewayProbeAuthSafe as i, collectEnabledInsecureOrDangerousFlags as n, collectIncludePathsRecursive as r, runSecurityAudit as t };