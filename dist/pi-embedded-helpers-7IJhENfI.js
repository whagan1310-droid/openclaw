import { f as resolveSessionAgentId, i as resolveAgentConfig } from "./run-with-concurrency-C_CE05l4.js";
...
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BCj7Axtv.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-uYL2gEou.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BjtzgbP_.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CGPDxowG.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-CGPDxowG.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
//#endregion
export { deliveryContextKey as $, matchesAnyGlobPattern as $t, isRawApiErrorPayload as A, resolveGroupSessionKey as At, parseSessionThreadInfo as B, resolveGatewayCredentialsFromConfig as Bt, isCloudCodeAssistFormatError as C, setSessionRuntimeModel as Ct, isFailoverErrorMessage as D, resolveMainSessionKey as Dt, isFailoverAssistantError as E, resolveExplicitAgentSessionKey as Et, isTimeoutErrorMessage as F, resolveBrowserConfig as Ft, readSessionUpdatedAt as G, collectExplicitAllowlist as Gt, resolveMirroredTranscriptText as H, resolveSandboxConfigForAgent as Ht, ensureSandboxWorkspaceForSession as I, resolveProfile as It, updateSessionStore as J, stripPluginOnlyAllowlist as Jt, recordSessionMetaFromInbound as K, expandPolicyWithPluginGroups as Kt, resolveSandboxContext as L, getBridgeAuthForPort as Lt, parseImageDimensionError as M, resolveSessionLockMaxHoldFromTimeout as Mt, parseImageSizeError as N, createBrowserRouteContext as Nt, isLikelyContextOverflowError as O, deriveSessionMetaPatch as Ot, sanitizeUserFacingText as P, registerBrowserRoutes as Pt, deliveryContextFromSession as Q, compileGlobPatterns as Qt, resolveSandboxRuntimeStatus as R, ensureBrowserControlAuth as Rt, isBillingAssistantError as S, resolveFreshSessionTotalTokens as St, isContextOverflowError as T, resolveAgentMainSessionKey as Tt, resolveAndPersistSessionFile as U, applyOwnerOnlyToolPolicy as Ut, appendAssistantMessageToSessionTranscript as V, trimToUndefined as Vt, loadSessionStore as W, buildPluginToolGroups as Wt, isCacheEnabled as X, normalizeToolName as Xt, updateSessionStoreEntry as Y, expandToolGroups as Yt, resolveCacheTtlMs as Z, resolveToolProfilePolicy as Zt, formatAssistantErrorText as _, resolveSessionResetPolicy as _t, isMessagingToolDuplicateNormalized as a, sanitizeGoogleTurnOrdering as an, capArrayByJsonBytes as at, getApiErrorPayloadFingerprint as b, DEFAULT_RESET_TRIGGERS as bt, extractToolCallsFromAssistant as c, parseInlineDirectives as ct, downgradeOpenAIFunctionCallReasoningPairs as d, hasInterSessionUserProvenance as dt, buildBootstrapContextFiles as en, mergeDeliveryContext as et, downgradeOpenAIReasoningBlocks as f, normalizeInputProvenance as ft, classifyFailoverReasonFromHttpStatus as g, resolveChannelResetConfig as gt, classifyFailoverReason as h, evaluateSessionFreshness as ht, isMessagingToolDuplicate as i, resolveBootstrapTotalMaxChars as in, archiveSessionTranscripts as it, isTransientHttpError as j, acquireSessionWriteLock as jt, isRateLimitAssistantError as k, resolveConversationLabel as kt, extractToolResultId as l, INPUT_PROVENANCE_KIND_VALUES as lt, BILLING_ERROR_USER_MESSAGE as m, resolveSessionKey as mt, validateGeminiTurns as n, resolveBootstrapMaxChars as nn, normalizeSessionDeliveryFields as nt, normalizeTextForComparison as o, countToolResults as ot, isGoogleModelApi as p, jsonUtf8Bytes as pt, updateLastRoute as q, mergeAlsoAllowPolicy as qt, pickFallbackThinkingLevel as r, resolveBootstrapPromptTruncationWarningMode as rn, normalizeAccountId as rt, sanitizeSessionMessagesImages as s, extractToolCallNames as st, validateAnthropicTurns as t, ensureSessionHeader$1 as tn, normalizeDeliveryContext as tt, sanitizeToolCallIdsForCloudCodeAssist as u, applyInputProvenanceToUserMessage as ut, formatBillingErrorMessage as v, resolveSessionResetType as vt, isCompactionFailureError as w, canonicalizeMainSessionAlias as wt, isAuthAssistantError as x, mergeSessionEntry as xt, formatRawAssistantErrorForUi as y, resolveThreadFlag as yt, extractDeliveryInfo as z, resolveBrowserControlAuth as zt };