import { $ as normalizeAgentId, I as resolvePathViaExistingAncestorSync, J as buildAgentMainSessionKey, K as DEFAULT_AGENT_ID, O as runExec, S as ensureAgentWorkspace, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, et as normalizeMainKey, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, st as normalizeOptionalAccountId, tt as resolveAgentIdFromSessionKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-ab1joTSj.js";
import { Bn as isPidAlive, Rn as resolveProcessScopedMap, ar as resolveSecretInputRef, b as parseDurationMs, er as parseBooleanValue, kn as secretRefKey, kr as formatCliCommand, n as loadConfig, nr as hasConfiguredSecretInput, o as writeConfigFile, or as CHANNEL_IDS, t as createConfigIO, wn as resolveSecretRefValues, x as parseByteSize, y as getBlockedNetworkModeReason, zn as getProcessStartTime } from "./config--DRASumq.js";
import { E as truncateUtf16Safe, O as createSubsystemLogger, h as normalizeE164, j as defaultRuntime, y as resolveUserPath } from "./logger-Bl138Nx7.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-0d8fBoC4.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-B07F4eF-.js";
import { d as getChannelDock, o as normalizeThinkLevel, y as normalizeHyphenSlug } from "./thinking-D9WAhjRI.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-C39TxwvE.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-DmMK7U5L.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-DtF9ARSD.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-C-Yjj9jM.js";
import { C as ensureChromeExtensionRelayServer, D as PROFILE_POST_RESTART_WS_TIMEOUT_MS, E as PROFILE_ATTACH_RETRY_TIMEOUT_MS, G as DEFAULT_BROWSER_EVALUATE_ENABLED, H as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, I as resolveWritablePathWithinRoot, J as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, K as DEFAULT_OPENCLAW_BROWSER_COLOR, M as DEFAULT_TRACE_DIR, N as DEFAULT_UPLOAD_DIR, O as resolveCdpReachabilityTimeouts, P as resolveExistingPathsWithinRoot, R as normalizeBrowserFormField, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_AI_SNAPSHOT_MAX_CHARS, V as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, W as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_DOWNLOAD_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, q as DEFAULT_OPENCLAW_BROWSER_ENABLED, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson, z as isLoopbackHost } from "./chrome-Pd5FxDO3.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-ZOrsklaM.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-BBXtPn2S.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-B2jpHiod.js";
import { n as SsrFBlockedError } from "./proxy-env-0Kn4CclB.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-Bai6Vi8P.js";
import { t as generateSecureToken } from "./secure-random-D2mQUJdh.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-DMbvk-PO.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DuFJbsyV.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CO-sImOa.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-CO-sImOa.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
//#endregion
export { mergeAlsoAllowPolicy as $, canonicalizeMainSessionAlias as $t, isRawApiErrorPayload as A, normalizeAccountId as At, registerBrowserRoutes as B, jsonUtf8Bytes as Bt, isCloudCodeAssistFormatError as C, isCacheEnabled as Ct, isFailoverErrorMessage as D, mergeDeliveryContext as Dt, isFailoverAssistantError as E, deliveryContextKey as Et, isTimeoutErrorMessage as F, parseInlineDirectives as Ft, resolveBrowserControlAuth as G, resolveChannelResetConfig as Gt, resolveProfile as H, resolveSessionLockMaxHoldFromTimeout as Ht, ensureSandboxWorkspaceForSession as I, INPUT_PROVENANCE_KIND_VALUES as It, resolveSandboxConfigForAgent as J, resolveThreadFlag as Jt, resolveGatewayCredentialsFromConfig as K, resolveSessionResetPolicy as Kt, resolveSandboxContext as L, applyInputProvenanceToUserMessage as Lt, parseImageDimensionError as M, capArrayByJsonBytes as Mt, parseImageSizeError as N, countToolResults as Nt, isLikelyContextOverflowError as O, normalizeDeliveryContext as Ot, sanitizeUserFacingText as P, extractToolCallNames as Pt, expandPolicyWithPluginGroups as Q, setSessionRuntimeModel as Qt, resolveSandboxRuntimeStatus as R, hasInterSessionUserProvenance as Rt, isBillingAssistantError as S, updateSessionStoreEntry as St, isContextOverflowError as T, deliveryContextFromSession as Tt, getBridgeAuthForPort as U, resolveSessionKey as Ut, resolveBrowserConfig as V, acquireSessionWriteLock as Vt, ensureBrowserControlAuth as W, evaluateSessionFreshness as Wt, buildPluginToolGroups as X, mergeSessionEntry as Xt, applyOwnerOnlyToolPolicy as Y, DEFAULT_RESET_TRIGGERS as Yt, collectExplicitAllowlist as Z, resolveFreshSessionTotalTokens as Zt, formatAssistantErrorText as _, loadSessionStore as _t, isMessagingToolDuplicateNormalized as a, matchesAnyGlobPattern as at, getApiErrorPayloadFingerprint as b, updateLastRoute as bt, extractToolCallsFromAssistant as c, resolveBootstrapMaxChars as ct, downgradeOpenAIFunctionCallReasoningPairs as d, sanitizeGoogleTurnOrdering as dt, resolveExplicitAgentSessionKey as en, stripPluginOnlyAllowlist as et, downgradeOpenAIReasoningBlocks as f, extractDeliveryInfo as ft, classifyFailoverReasonFromHttpStatus as g, resolveAndPersistSessionFile as gt, classifyFailoverReason as h, resolveMirroredTranscriptText as ht, isMessagingToolDuplicate as i, resolveGroupSessionKey as in, compileGlobPatterns as it, isTransientHttpError as j, archiveSessionTranscripts as jt, isRateLimitAssistantError as k, normalizeSessionDeliveryFields as kt, extractToolResultId as l, resolveBootstrapPromptTruncationWarningMode as lt, BILLING_ERROR_USER_MESSAGE as m, appendAssistantMessageToSessionTranscript as mt, validateGeminiTurns as n, deriveSessionMetaPatch as nn, normalizeToolName as nt, normalizeTextForComparison as o, buildBootstrapContextFiles as ot, isGoogleModelApi as p, parseSessionThreadInfo as pt, trimToUndefined as q, resolveSessionResetType as qt, pickFallbackThinkingLevel as r, resolveConversationLabel as rn, resolveToolProfilePolicy as rt, sanitizeSessionMessagesImages as s, ensureSessionHeader as st, validateAnthropicTurns as t, resolveMainSessionKey as tn, expandToolGroups as tt, sanitizeToolCallIdsForCloudCodeAssist as u, resolveBootstrapTotalMaxChars as ut, formatBillingErrorMessage as v, readSessionUpdatedAt as vt, isCompactionFailureError as w, resolveCacheTtlMs as wt, isAuthAssistantError as x, updateSessionStore as xt, formatRawAssistantErrorForUi as y, recordSessionMetaFromInbound as yt, createBrowserRouteContext as z, normalizeInputProvenance as zt };