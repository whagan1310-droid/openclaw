...
import { $n as isTruthyEnvValue, Ln as withFileLock$1, i as readConfigFileSnapshotForWrite, jt as resolveTelegramPreviewStreamMode, n as loadConfig, o as writeConfigFile } from "./config--DRASumq.js";
import { F as danger, L as logVerbose, O as createSubsystemLogger, a as CONFIG_DIR, b as safeParseJson } from "./logger-Bl138Nx7.js";
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix, o as resolveOAuthDir } from "./paths-0d8fBoC4.js";
import { n as listChannelPlugins, t as getChannelPlugin, u as resolveTelegramAccount } from "./plugins-B07F4eF-.js";
import { h as normalizeMimeType, m as kindFromMime, p as isGifMedia, u as getFileExtension } from "./image-ops-C39TxwvE.js";
import { r as writeJsonAtomic } from "./json-files-DtF9ARSD.js";
import { t as redactSensitiveText } from "./redact-C3rEm8A0.js";
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-B2jpHiod.js";
import { t as hasProxyEnvConfigured } from "./proxy-env-0Kn4CclB.js";
import { t as makeProxyFetch } from "./proxy-fetch-C-fXKPD2.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-zvBCYv_R.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-DFO4p139.js";
import { t as renderMarkdownWithMarkers } from "./render-CF8xRF8z.js";
import { n as normalizePollInput } from "./polls-cWLKt9XC.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-nUN6kIwM.js";
import { t as resolveFetch } from "./fetch-CdwFGsMf.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-D0-GMKRD.js";
...
//#endregion
export { readChannelAllowFromStore as $, expandTextLinks as A, resolveTelegramThreadSpec as B, buildSenderName as C, buildTelegramThreadParams as D, buildTelegramParentPeer as E, resolveTelegramForumThreadId as F, firstDefined as G, normalizeAllowFrom as H, resolveTelegramGroupAllowFromContext as I, resolveGroupAllowFromSources as J, isSenderIdAllowed as K, resolveTelegramMediaPlaceholder as L, hasBotMention as M, normalizeForwardedContext as N, buildTypingThreadParams as O, resolveTelegramDirectPeerId as P, addChannelAllowFromStoreEntry as Q, resolveTelegramReplyId as R, buildSenderLabel as S, buildTelegramGroupPeerId as T, normalizeDmAllowFromWithStore as U, isSenderAllowed as V, resolveSenderAllowMatch as W, toLocationContext as X, formatLocationText as Y, isVoiceCompatibleAudio as Z, wrapFileReferencesInHtml as _, reactMessageTelegram as a, getPairingAdapter as at, withTelegramApiErrorLogging as b, sendStickerTelegram as c, resolveCronStorePath as d, readChannelAllowFromStoreSync as et, wasSentByBot as f, renderTelegramHtmlText as g, markdownToTelegramHtml as h, editMessageTelegram as i, writeJsonFileAtomically as it, extractTelegramLocation as j, describeReplyTarget as k, resolveTelegramVoiceSend as l, markdownToTelegramChunks as m, createForumTopicTelegram as n, upsertChannelPairingRequest as nt, sendMessageTelegram as o, listPairingChannels as ot, isRecoverableTelegramNetworkError as p, mergeDmAllowFromSources as q, deleteMessageTelegram as r, readJsonFileWithFallback as rt, sendPollTelegram as s, buildInlineKeyboard as t, removeChannelAllowFromStoreEntry as tt, loadCronStore as u, resolveTelegramFetch as v, buildTelegramGroupFrom as w, buildGroupLabel as x, splitTelegramCaption as y, resolveTelegramStreamMode as z };