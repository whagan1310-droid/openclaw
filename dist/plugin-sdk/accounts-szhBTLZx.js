import { at as DEFAULT_ACCOUNT_ID, ot as normalizeAccountId, st as normalizeOptionalAccountId } from "./run-with-concurrency-ab1joTSj.js";
import { kr as formatCliCommand } from "./config--DRASumq.js";
import { B as success, G as getChildLogger, I as info, j as defaultRuntime, m as jidToE164, y as resolveUserPath } from "./logger-Bl138Nx7.js";
import { o as resolveOAuthDir } from "./paths-0d8fBoC4.js";
...
function resolveWhatsAppMediaMaxBytes(account) {
	return (typeof account.mediaMaxMb === "number" && account.mediaMaxMb > 0 ? account.mediaMaxMb : DEFAULT_WHATSAPP_MEDIA_MAX_MB) * 1024 * 1024;
}

//#endregion
export { resolveWebCredsPath as _, resolveWhatsAppAuthDir as a, createAccountListHelpers as b, getWebAuthAgeMs as c, maybeRestoreCredsFromBackup as d, pickWebChannel as f, resolveWebCredsBackupPath as g, resolveDefaultWebAuthDir as h, resolveWhatsAppAccount as i, logWebSelfId as l, readWebSelfId as m, listWhatsAppAccountIds as n, resolveWhatsAppMediaMaxBytes as o, readCredsJsonRaw as p, resolveDefaultWhatsAppAccountId as r, WA_WEB_AUTH_DIR as s, hasAnyWhatsAppAuth as t, logoutWeb as u, webAuthExists as v, resolveAccountEntry as y };