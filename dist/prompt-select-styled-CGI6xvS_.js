...
import { Ar as resolveHooksGmailModel, G as writeConfigFile, Hi as CLAUDE_CLI_PROFILE_ID, Jn as repairOAuthProfileIdMismatch, Or as resolveConfiguredModelRef, Ri as DEFAULT_MODEL, Ui as CODEX_CLI_PROFILE_ID, V as readConfigFileSnapshot, d as resolveApiKeyForProfile, gi as resolveApiKeyForProvider, l as resolveProfileUnusableUntilForDisplay, lt as secretRefKey, nr as ensureAuthProfileStore, or as updateAuthProfileStoreWithLock, vr as getModelRefStatus, x as resolveSecretRefValues, zi as DEFAULT_PROVIDER } from "./auth-profiles-XSsJj4N1.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-Bfb1NlQ6.js";
import { E as parseAgentSessionKey } from "./session-key-k6urs9r-.js";
...
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-ChOF9pID.js";
import { Fr as resolveBootstrapContextForRun, Jt as buildAuthHealthSummary, Tr as buildBootstrapInjectionStats, Yt as formatRemainingShort, c as loadOpenClawPlugins, kr as resolveAgentSessionDirs, qt as DEFAULT_OAUTH_WARN_MS, wr as analyzeBootstrapBudget } from "./compact-C1fHmpxR.js";
import { n as listChannelPlugins } from "./plugins-DRFogx00.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-Bv8-njDx.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-dCWvM5iw.js";
import { d as resolveGatewayBindHost, i as isLoopbackHost } from "./ws-Da560NJf.js";
import { a as resolveGatewayAuth } from "./auth-vwV9EhNu.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-D-6FS_Ji.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-TdGFisXq.js";
import { Q as resolveMainSessionKey, ct as cleanStaleLockFiles, it as isPrimarySessionTranscriptFileName, o as loadSessionStore, rt as formatSessionArchiveTimestamp } from "./sessions-G4D58Ojj.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-CCvn4cNJ.js";
import { n as loadModelCatalog } from "./model-catalog-gOiarqwC.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-C79Luiuk.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-BJ05mNzH.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-CJHAeadq.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-CvQfS6aU.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-BSbYkxLh.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-4wb3GpM-.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-DEI46tD-.js";
import { i as resolveMemorySearchConfig, n as DEFAULT_LOCAL_MODEL, r as hasConfiguredMemorySecretInput } from "./manager-YKoUJnF5.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-0PWts_Ys.js";
import { t as note$1 } from "./note-D-3vxUal.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-D97PtG3e.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-De2rRniV.js";
...
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-D5gNH924.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-DAmsCq52.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-DxznmhTf.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-CqlvNZQm.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CFVgm8aH.js";
import { r as healthCommand } from "./health-BjquzFki.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-CuTHo0-A.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CpPRj7EP.js";
import { t as runGatewayUpdate } from "./update-runner-D4MbfB_R.js";
import { n as logConfigUpdated } from "./logging-BM8NiFir.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-Cw3pp4hq.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-BR2D6uTm.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BI9FOuxq.js";
import { t as formatHealthCheckFailure } from "./health-format-Cm50XGh2.js";
import { n as doctorShellCompletion } from "./doctor-completion-DsdApPqV.js";
...
async function resolveGatewayAuthTokenForService(cfg, env) {
	...
	const configToken = ref || typeof cfg.gateway?.auth?.token !== "string" ? void 0 : cfg.gateway.auth.token.trim() || void 0;
	if (configToken) return { token: configToken };
	if (ref) try {
		const value = (await resolveSecretRefValues([ref], {
			config: cfg,
			env
		})).get(secretRefKey(ref));
		if (typeof value === "string" && value.trim().length > 0) return { token: value.trim() };
		...
		const envToken = readGatewayTokenEnv(env);
		if (envToken) return { token: envToken };
		return { unavailableReason: `gateway.auth.token SecretRef is configured but unresolved (${String(err)}).` };
	}
...
async function maybeRepairGatewayServiceConfig(cfg, mode, runtime, prompter) {
	...
	for (const warning of installTokenResolution.warnings) note$1(warning, "Gateway service config");
	if (installTokenResolution.unavailableReason) {
		note$1(`Unable to verify gateway service token drift: ${installTokenResolution.unavailableReason}`, "Gateway service config");
		return;
	}
	const { programArguments, workingDirectory, environment } = await buildGatewayInstallPlan({
		env: process.env,
