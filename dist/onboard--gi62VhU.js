...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-Cfn2Pryx.js";
import { G as writeConfigFile, V as readConfigFileSnapshot, ct as resolveDefaultSecretProviderAlias } from "./auth-profiles-XSsJj4N1.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { v as resolveUserPath } from "./utils-cwpAMi-t.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-ChOF9pID.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-BSbYkxLh.js";
import { t as WizardCancelledError } from "./prompts-knTF_LVq.js";
import { t as createClackPrompter } from "./clack-prompter-BlKetjG7.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DgCE52lk.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-DCon-pbN.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-dHs3THEv.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-_ECwUsJy.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Dqd6_cIO.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BjquzFki.js").then((n) => n.i);
