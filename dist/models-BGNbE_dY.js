...
import { $n as upsertAuthProfile, Bi as resolveAuthProfileDisplayLabel, Ci as shouldEnableShellEnvFallback, Or as resolveConfiguredModelRef, Qn as setAuthProfileOrder, Ri as DEFAULT_MODEL, Tr as parseModelRef, Xn as listProfilesForProvider, _i as resolveAwsSdkEnvVarName, _r as findNormalizedProviderValue, bi as getShellEnvAppliedKeys, cr as resolveAuthStorePathForDisplay, gi as resolveApiKeyForProvider, gr as buildModelAliasIndex, jr as resolveModelRefFromString, kr as resolveDefaultModelForAgent, l as resolveProfileUnusableUntilForDisplay, lr as resolveOpenClawAgentDir, mi as getCustomProviderApiKey, n as resolveAuthProfileEligibility, nr as ensureAuthProfileStore, pt as parseDurationMs, r as resolveAuthProfileOrder, vi as resolveEnvApiKey, wr as normalizeProviderId, xr as modelKey, y as resolveSecretRefString, z as loadConfig, zi as DEFAULT_PROVIDER } from "./auth-profiles-XSsJj4N1.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-Bfb1NlQ6.js";
import { x as shortenHomePath } from "./utils-cwpAMi-t.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-ChOF9pID.js";
import { Dr as describeFailoverError, Jt as buildAuthHealthSummary, Kt as maskApiKey, Yt as formatRemainingShort, Zr as resolveModelWithRegistry, dn as loadProviderUsageSummary, mn as resolveUsageProviderId, pn as formatUsageWindowSummary, pr as runEmbeddedPiAgent, qt as DEFAULT_OAUTH_WARN_MS } from "./compact-C1fHmpxR.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-Cs1I38zv.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-CCvn4cNJ.js";
import { t as ensureOpenClawModelsJson } from "./models-config-_Eeii_hA.js";
import { n as loadModelCatalog } from "./model-catalog-gOiarqwC.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-BLNsV-9B.js";
import { f as openUrl } from "./onboard-helpers-BSbYkxLh.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-4wb3GpM-.js";
import { r as withProgressTotals } from "./progress-BCOseYmX.js";
import { t as createClackPrompter } from "./clack-prompter-BlKetjG7.js";
import { t as renderTable } from "./table-BUufxB8A.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-B4zgtyK2.js";
import { n as redactSecrets } from "./format-DV0kBc74.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-DHTKfDaK.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-usm8Z3nH.js";
import { n as logConfigUpdated } from "./logging-BM8NiFir.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-CbMuBzP6.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-XSsJj4N1.js").then((n) => n.t);
	const cfg = await loadModelsConfig({
