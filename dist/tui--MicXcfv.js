import { c as normalizeUsageDisplay, r as listThinkingLevelLabels, t as formatThinkingLevels, u as resolveResponseUsageMode } from "./thinking-Fqckw03T.js";
import { d as resolveDefaultAgentId } from "./agent-scope-C_RF521q.js";
import { c as stripAnsi$1, l as visibleWidth } from "./subsystem-D5pRlZe-.js";
import { E as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-CIXZm7v4.js";
import { $t as loadConfig, oi as VERSION } from "./model-selection-BaeHlT6A.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-CmT3i4wb.js";
import { f as GATEWAY_CLIENT_CAPS, h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-CSTlX5lG.js";
import { y as formatRawAssistantErrorForUi } from "./pi-embedded-helpers-BPB21Ua-.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-Cwe8LsCR.js";
import { i as stripLeadingInboundMetadata } from "./chat-envelope-C9vncoSN.js";
import { r as resolveToolDisplay, t as formatToolDetail } from "./tool-display-UQpRiLW1.js";
import { a as listChatCommandsForConfig, i as listChatCommands } from "./commands-registry-BHnndXec.js";
import { Pt as PROTOCOL_VERSION, t as GatewayClient } from "./client-DPuEGSE_.js";
import { i as ensureExplicitGatewayAuth, o as resolveExplicitGatewayAuth, t as buildGatewayConnectionDetails } from "./call-CqTAcmXH.js";
import { n as formatTimeAgo, t as formatRelativeTimestamp } from "./format-relative-BsYuWm-Q.js";
import { n as formatTokenCount } from "./usage-format-AUy5dHjp.js";
...
async function resolveGatewayConnection(opts) {
	...
	if (gatewayAuthMode === "token") {
		const localToken = explicitAuth.token || envToken ? { value: explicitAuth.token ?? envToken } : await resolveConfiguredSecretInputString({
