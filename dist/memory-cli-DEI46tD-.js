...
import { Cn as splitShellArgs, pt as parseDurationMs, z as loadConfig } from "./auth-profiles-XSsJj4N1.js";
...
import { d as listMemoryFiles, f as normalizeExtraMemoryPaths } from "./sqlite-BYIXRIVi.js";
import { r as getMemoryCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-BLNsV-9B.js";
...
import { n as withProgress, r as withProgressTotals } from "./progress-BCOseYmX.js";
...
function loadManagerRuntime() {
	managerRuntimePromise ??= import("./manager-runtime-2pT-t7i2.js");
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-CQjIEAH2.js");
