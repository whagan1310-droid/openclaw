...
import { At as AVATAR_MAX_BYTES, It as isWorkspaceRelativeAvatarPath, Li as DEFAULT_CONTEXT_TOKENS, Mt as isAvatarHttpUrl, Or as resolveConfiguredModelRef, Pt as isPathWithinRoot, Ri as DEFAULT_MODEL, Rt as resolveAvatarMime, Tr as parseModelRef, jt as isAvatarDataUrl, kr as resolveDefaultModelForAgent, lr as resolveOpenClawAgentDir, yr as inferUniqueProviderFromConfiguredModels, z as loadConfig, zi as DEFAULT_PROVIDER } from "./auth-profiles-XSsJj4N1.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-Bfb1NlQ6.js";
import { C as isCronRunSessionKey, E as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey } from "./session-key-k6urs9r-.js";
import { a as openBoundaryFileSync } from "./openclaw-root-BFfBQ6FD.js";
import { C as normalizeSessionDeliveryFields, Q as resolveMainSessionKey, X as resolveAgentMainSessionKey, Y as canonicalizeMainSessionAlias, at as buildGroupDisplayName, j as readSessionTitleFieldsFromTranscript, o as loadSessionStore, q as resolveFreshSessionTotalTokens } from "./sessions-G4D58Ojj.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-Cs1I38zv.js").then((n) => n.r);
