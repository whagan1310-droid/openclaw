...
import { G as writeConfigFile, V as readConfigFileSnapshot, ct as resolveDefaultSecretProviderAlias, nr as ensureAuthProfileStore, z as loadConfig } from "./auth-profiles-XSsJj4N1.js";
...
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-ChOF9pID.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./plugins-DRFogx00.js";
import { a as findTailscaleBinary } from "./tailscale-Bm1Sl4zA.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, g as resolveControlUiLinks, h as randomToken, m as probeGatewayReachable, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, v as summarizeExistingConfig, y as validateGatewayPasswordInput } from "./onboard-helpers-BSbYkxLh.js";
...
import { r as setupChannels, t as noteChannelStatus } from "./onboard-channels-UKOSHReu.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CuTHo0-A.js";
import { t as resolveOnboardingSecretInputString } from "./onboarding.secret-input-Bdbm4UJF.js";
import { n as logConfigUpdated } from "./logging-BM8NiFir.js";
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-C-cdA10R.js";
import { i as applyAuthChoice, n as resolvePreferredProviderForAuthChoice } from "./auth-choice-DNYnwJ9j.js";
import { a as promptDefaultModel, n as applyModelFallbacksFromSelection, o as promptModelAllowlist, r as applyPrimaryModel, t as applyModelAllowlist } from "./model-picker-CapIdFRV.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BI9FOuxq.js";
import { a as promptCustomApiConfig } from "./onboard-custom-CC0QAUA2.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-K88X0bYq.js";
import { t as formatHealthCheckFailure } from "./health-format-Cm50XGh2.js";
import { n as promptRemoteGatewayConfig } from "./onboard-remote-B-tIOZMz.js";
import { n as setupSkills } from "./onboard-skills-BmKN1NRg.js";
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, applySearchKey, hasKeyInEnv } = await import("./onboard-search-DXDAqpNy.js");
