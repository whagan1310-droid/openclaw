...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-D5pRlZe-.js";
import { Sn as resolveDefaultSecretProviderAlias, an as writeConfigFile, tn as readConfigFileSnapshot } from "./model-selection-BaeHlT6A.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-CmT3i4wb.js";
import { t as formatCliCommand } from "./command-format-Gp1OUMPH.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-CKPkIyNp.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Dp28yNwO.js";
import { t as runOnboardingWizard } from "./onboarding-CiOw5Y9Q.js";
import { n as logConfigUpdated } from "./logging-CEi-PIBm.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-BlYkJpb7.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-LavyKOIh.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-nmPtYkUc.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-vIhOg70Z.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-D2J-Uw9p.js").then((n) => n.i);
